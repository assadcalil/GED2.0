...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $dadosFormulario = array(
        ...
        'certificado_tipo' => isset($_POST['certificado_tipo']) ? $_POST['certificado_tipo'] : '',
    ...
    if (isset($_POST['acao']) && $_POST['acao'] === 'enviar_email') {
        ...
        elseif (empty($dadosFormulario['certificado_tipo'])) {
                    ...
                    <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data" id="form-certificado">
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label for="certificado_tipo" class="form-label">Tipo de Certificado</label>
                                        <select name="certificado_tipo" id="certificado_tipo" class="form-select" required>
                                            <option value="">Selecione o tipo...</option>
                                            <?php foreach ($tiposCertificado as $valor => $nome): ?>
                                            <option value="<?php echo $valor; ?>" <?php echo ($dadosFormulario['certificado_tipo'] === $valor) ? 'selected' : ''; ?>>
                                                <?php echo $nome; ?>
                                            </option>
                                            <?php endforeach; ?>
                                        </select>
