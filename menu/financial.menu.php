<?php
/**
 * Menu para usuários do tipo FINANCIAL (Financeiro)
 */
...
<div class="sidebar-menu">
    ...
    <!-- Menu Financeiro (simplificado para apenas um link) -->
    <div class="menu-item <?php echo isMenuActive('/financial', $currentPath) ? 'active' : ''; ?>">
        <a href="/GED2.0/views/financial/dashboard.php">
