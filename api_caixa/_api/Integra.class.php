<?php
    ...
    require_once __DIR__ . '/../_validator/Validator.class.php';
    require_once __DIR__ . '/RegistraBoleto.class.php';
    require_once __DIR__ . '/ConsultaBoleto.class.php';
    require_once __DIR__ . '/AlteraBoleto.class.php';
    require_once __DIR__ . '/BaixaBoleto.class.php';
    ...
    class Integra extends Validator {
        ...
        private $codigo_beneficiario    = '0720907';
        private $cnpj_beneficiario      = '02032391000151';
        ...
        public function RegistraBoletoCaixa($nosso_numero, $data_vencimento, $valor, $codigo, $data_lancamento, $nome_contato, $cpf_cnpj_contato){
            ...
            $ArrRegistra = array(
                ...
                'infoPagador' => array(
                    ...
                    'ENDERECO' => array(
                        'LOGRADOURO' => 'AVENIDA JULIO BUONO, N 2525, 2 ANDAR',
                        'BAIRRO' => 'VILA GUSTAVO',
                        'CIDADE' => 'SAO PAULO',
                        'UF' => 'SP',
                        'CEP' => '02201001'
